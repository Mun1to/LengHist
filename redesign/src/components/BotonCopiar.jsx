...
export default function BotonCopiar({ texto, etiqueta, etiquetaHecho, compacto = false }) {
  ...
  return (
    <button
      ...
      title={etiqueta}
      aria-label={etiqueta}
      className={`inline-flex items-center gap-1.5 rounded-lg text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100 cursor-pointer transition-colors ${
