...
export function createPeel(
  ...
  // con el renderizador que canvasui ya usa en Asciify, y lo subimos como textura.
  captureFallback = () => {
    if (htmlInCanvas) return;
    try {
...
export function Peel({
  ...
  return (
    <div className={className} style={{ position: "relative", ...style }}>
      {/* La capa de debajo se monta siempre: con el respaldo tambien hace falta
          algo real que asome cuando la portada se levanta. */}
      <div
        ref={underRef}
        style={{
          position: "absolute",
