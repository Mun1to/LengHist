...
const rango = 'w-full accent-indigo-500 h-1 cursor-pointer'
    ...
    <div className="cd-box p-3 flex flex-col justify-center gap-3">
      <div className="cd-cq mx-auto" style={{ width: ancho, transition: 'width .1s linear' }}>
        <div className="cd-cq-grid grid grid-cols-1 gap-1.5 border border-zinc-700 rounded p-2">
          <div className="h-8 rounded bg-indigo-500/70" />
          <div className="h-8 rounded bg-indigo-500/40" />
        </div>
      </div>
  ...
  return (
    <div className="cd-box p-3 flex flex-col justify-center gap-3">
      <div className="cd-cq mx-auto grid place-items-center" style={{ width: ancho }}>
        <div className="cd-fluid font-extrabold text-indigo-200 leading-none whitespace-nowrap">Vibeset</div>
      </div>
  ...
  return (
    <div className="cd-box grid place-items-center">
      <form className="cd-has-form w-[190px]" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="cd-has-panel cd-card mt-3 text-center font-bold text-indigo-300">{t.continuar}</div>
      </form>
...
export function ColorMix() {
  ...
  const mezcla = `color-mix(in oklab, #6366f1 ${pct}%, #f97316)`
  return (
    <div className="cd-box p-3 flex flex-col justify-center gap-3">
      <div className="flex items-center gap-2">
        <div className="w-7 h-7 rounded shrink-0" style={{ background: '#6366f1' }} />
  ...
  return (
    <div className="cd-box grid place-items-center gap-3">
      <div dir={rtl ? 'rtl' : 'ltr'} className="w-[190px]">
        <div
          className="cd-card"
          style={{ borderInlineStart: '3px solid #6366f1', paddingInlineStart: 12, marginInline: 'auto' }}
        >
